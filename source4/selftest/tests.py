...
plantestsuite("samba4.blackbox.net_ads_search(ad_member:local)", "ad_member:local", [os.path.join(bbdir, "test_net_ads_search.sh"), '$DOMAIN', '$REALM', '$DC_USERNAME', '$DC_PASSWORD', "$PREFIX/ad_member"])

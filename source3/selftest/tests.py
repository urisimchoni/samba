...
for env in ["fileserver"]:
    ...
    plantestsuite("samba3.blackbox.protect SMB3 (%s)" % env, env, [os.path.join(samba3srcdir, "script/tests/test_protect.sh"), '$SERVER', '$SERVER_IP', '$USERNAME', '$PASSWORD', '$LOCAL_PATH/protect', smbclient3, '-m', 'SMB3'])
